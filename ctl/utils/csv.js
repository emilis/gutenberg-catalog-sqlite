...
/**
 * Writes two-dimensional array to a file.
 */
exports.writeFile = function(file_name, list, fields) {

    fields = fields || Object.keys(list[0]);

    var file = fs.open(file_name, "w");

    // write field names on first line:
    file.writeLine(csvLine(fields));
